...
from agent.workflow.layered import OPTIONAL_DEEP, get_optional_deep_points
...
def build_expandable_topics(
    ...
    for point in get_optional_deep_points(plan):
        snapshots = [
        ...
        topics.append(
            ExpandableTopic(
                ...
                focal_point={**point, "generation_mode": OPTIONAL_DEEP},
                articles=snapshots,
            )
        )
